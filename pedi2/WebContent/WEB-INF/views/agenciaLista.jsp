...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h2 class="page-header mini">Agencias
                    	<a href="#" onclick="agregar(0,'agencia');" class="btn btn-primary" title="Nueva agencia"><span class="glyphicon glyphicon-plus"></span></a>
                    	<c:choose>
