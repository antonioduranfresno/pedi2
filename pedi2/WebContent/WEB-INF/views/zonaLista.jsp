...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h2 class="page-header mini">Zonas
                    	<a href="#" onclick="agregar(0,'zona');" class="btn btn-primary" title="Nueva zona"><span class="glyphicon glyphicon-plus"></span></a>
                    	<c:choose>
	...
	<div id="modalMaestra" class="modal fade">
	  ...
	  <div class="modal-dialog">
	    ...
	    <div class="modal-header">
			...
			<h3 class="modal-title">Zona</h3>        
	    </div>
	      
		    <div class="modal-body">
		      
				<sf:form id="zonaForm" method="post" modelAttribute="zona">
					...
					<sf:input type="hidden" path="id"  />
				   	...
				   	<div class="row">
			        	<div class="col-sm-12">
			        		<label>Nombre</label>
			        		<label id="zona_nombre" class="error label label-danger"></label>			        			   
			        		<sf:input class="form-control" path="zona_nombre" maxlength="45" />		        		
			        	</div>
					</div>
					...
					<div class="footer">      
					 	...
					 	<div class="col-sm-12 derecha">			      		
				      		<input type="button" class="btn btn-primary" value="Aceptar" onclick="aceptar('zona');">
				      	</div>      	
